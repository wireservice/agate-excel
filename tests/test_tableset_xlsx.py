...
class TestSetXLSX(agate.AgateTestCase):
    def setUp(self):
        self.rows = (
    ...
    def test_from_xlsx(self):
        ...
        tableset2 = agate.TableSet.from_xlsx('examples/test_sheets.xlsx')
    ...
    def test_file_like(self):
        tableset1 = agate.MappedSequence(self.tables.values(), self.tables.keys())
        with open('examples/test_sheets.xlsx', 'rb') as f:
            tableset2 = agate.TableSet.from_xlsx(f)
    ...
    def test_sheet_name(self):
        ...
        tableset2 = agate.TableSet.from_xlsx('examples/test_sheets.xlsx', sheets=['data'])
    ...
    def test_sheet_index(self):
        ...
        tableset1 = agate.MappedSequence(tables.values(), tables.keys())
        tableset2 = agate.TableSet.from_xlsx('examples/test_sheets.xlsx', sheets=[1])
